...
class EmployeeServiceTest {
    ...
    void getSingleEmployee() {
        ...
        Assertions.assertEquals("John", employeeService.getEmployee(employee.getId()).getName());
        ...
        Assertions.assertEquals("Mary", employeeService.getEmployee(employee2.getId()).getName());
    ...
    void updateEmployee() {
        ...
        Assertions.assertEquals("John", employeeService.getEmployee(id1).getName());
        ...
        Assertions.assertEquals("Mary", employeeService.getEmployee(id1).getName());
